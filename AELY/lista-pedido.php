<?php 
    ...
    $sth = $pdo->prepare("SELECT * FROM `pedido` WHERE cd_usuario = $usuario order by dt_pedido");
    $sth->execute();                     
...
<div class="card rounded-3 mb-4">
        <div class="card-body p-4">
            ...
            <div class="col-md-3 col-lg-3 col-xl-3">
                <p class="lead fw-normal mb-2">Numero do pedido:</p>
              </div>
              <div class="col-md-3 col-lg-3 col-xl-3">
                <p class="lead fw-normal mb-2">data do pedido:</p>
              </div>
              <div class="col-md-3 col-lg-3 col-xl-3">
                <p class="lead fw-normal mb-2">Total do pedido:</p>
              </div>
            </div>
        </div>
    </div>
