...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18-Maio-2023 às 18:00
...
(2, 'yohan', 'yohan.aquino@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 0),
...
--
ALTER TABLE `pedido`
  MODIFY `cd_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `usuario`
--
ALTER TABLE `usuario`
  MODIFY `cd_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
